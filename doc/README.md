...
In the Menu, press ENTER to play the game.  
In the Game, press ENTER to return to the menu.  
ZQSD to move your character.  
At any moment :  
Press J to switch to Ncurses.  
Press K to switch to SFML.  
Press L to switch to SDL.  
In Ncurses, press X to quit the program.
